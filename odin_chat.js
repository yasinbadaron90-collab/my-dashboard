...
function clearAIChat(){
  ...
  if(msgs) msgs.innerHTML = '<div class="ai-empty" id="aiEmptyState">'
    ...
    +'<div class="ai-empty-sub">Try: "Can I buy sneakers for R800?"<br>or "What does Lezaun owe me?"<br>or "How is my cash flow this month?"</div>'
    +'</div>';
}
...
function odinMaintSummary(){
  ...
  try{
    ...
    var short=Math.max(0,getMaintTarget()-thisMonth);
    var out='<b>🔧 Maintenance Fund</b><br><br>';
    out+='This month: <b>'+fmtR(thisMonth)+'</b> of <b>'+fmtR(getMaintTarget())+'</b><br>';
