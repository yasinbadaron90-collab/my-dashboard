...
function renderBankBalanceCard(){
  ...
  // Live balances: baseline + tagged entries dated AFTER the baseline was set
  var cfData = (typeof loadCFData === 'function') ? loadCFData() : {};
  var baselineISO = saved.updated || null;
  var fnb  = _computeBankBucket('FNB',      cfData, fnbBase,  baselineISO);
  var tyme = _computeBankBucket('TymeBank', cfData, tymeBase, baselineISO);
  var cash = _computeBankBucket('Cash',     cfData, cashBase, baselineISO);
  var total = fnb + tyme + cash;
