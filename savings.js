...
function confirmDeposit(){
  ...
  // Refresh the Available Cash card so the bank that was drained shows its
  // new lower value immediately.
...
function openMoveToSavings(){
  ...
  var activeFunds = (typeof funds !== 'undefined' ? funds : []).filter(function(f){ return !f.isExpense && !f._deleted; });
