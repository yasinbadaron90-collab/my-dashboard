...
document.addEventListener('DOMContentLoaded', function(){
  // Load persisted carpool data into memory before any render runs.
  // Without this, cpData stays {} on page load and getDay() fills the
  // visible month with default unpaid R44 entries — which can then overwrite
  // saved data on the next saveCP().
