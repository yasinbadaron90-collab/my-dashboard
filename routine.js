        ...
        case 'maint':
          if(rule.maintEligible){
            ...
            if(mTargetId === '__maint__'){
              ...
              var mShort = Math.max(0, getMaintTarget()-mThisMonth);
              if(mShort>0){
                ...
                priorities.push({ type:'maint', label:'Maintenance Fund',
                  subLabel:'R'+mThisMonth.toFixed(0)+' of R'+getMaintTarget()+' this month — R'+mShort.toFixed(0)+' short'+(rule.carpoolIncome?'':' (salary supplement)'),
